      ...
      <Box sx={{ flexGrow: 1, p: 5 }} style={homeStyle}>
        <Grid container spacing={0}>
          <Grid item xs={3} sx={{ color: '#FDFDFF', }} >
            ...
            <h3 style={{ width: "100%", margin: "auto" }}> 9812+</h3>

            <h3 style={{ width: "100%", margin: "auto" }}> Students</h3>
          ...
          <Grid item xs={3} sx={{ color: '#FDFDFF' }} >
            ...
            <h3 style={{ width: "100%", margin: "auto" }}> Teachers</h3>
          ...
          <Grid item xs={3} sx={{ color: '#FDFDFF', textAlign: 'center' }} >
            ...
            <h3 style={{ width: "100%", margin: "auto" }}>Succesfully<br /> complete</h3>
          ...
          <Grid item xs={3} sx={{ color: '#FDFDFF' }} >
            ...
            <h3 style={{ width: "100%", margin: "auto" }}> Total couses</h3>
